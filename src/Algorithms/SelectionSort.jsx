...
const SelectionSort = () => {
  ...
  <h1 className="text-2xl font-bold text-gray-800 mb-4">Selection Sort</h1>
  ...
  <div className="bg-white relative flex rounded-lg shadow p-4 mb-4">
    ...
    <p className="text-gray-700 font-bold absolute right-10">Step: {currentSteps + 1} of {steps.length}</p>
  </div>
